...
: unitb.transient (meaning' p h₀ h₁) (valid' p (p.tr l)) :=
...
-- --  let liveness := p.liveness.snd,
-- --  have Hliveness : p.liveness.snd = liveness, refl,
-- --  destruct p.liveness,
-- --  intros n liveness Hliveness,
-- --  have Hliveness : p.liveness.snd = liveness,
